...
class BlockCategoryConfig extends BlockConfig
{
    ...
    {
        parent::__construct('zorbus_gallery.block.category', 'Category Block', $admin, $formFactory);
        $this->enabled = true;
        $this->themes = array(
            'ZorbusGalleryBundle:Block:category' => 'Default'
            );
    ...
    public function getFormMapper()
    {
        return $this->formMapper
                        ->add('category', 'entity', array(
                            'class' => 'Zorbus\\GalleryBundle\\Entity\\Category',
